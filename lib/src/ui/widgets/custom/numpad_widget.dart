...
class CustomNumPad extends StatefulWidget {
  ...
  const CustomNumPad({
    ...
    this.buttonTextStyle =
        const TextStyle(fontWeight: FontWeight.bold, fontSize: 24, color: Color(0xff005E54), fontFamily: null),
  }) : super(key: key);
                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(width: widget.buttonBorder, color: widget.buttonBorderColor)),
                        child: Center(
                          child: TextButton(
                            onPressed: () {
                    ...
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(
                            color: widget.buttonColor,
                            borderRadius: BorderRadius.circular(widget.buttonRadius),
                            border: Border.all(color: widget.buttonBorderColor, width: widget.buttonBorder)),
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(widget.buttonRadius),
                          child: TextButton(
                            onPressed: () {
