              ...
              SimpleButton(
                onPressed: () async {
                  ...
                  for (final day in AppDateUtils.getAllDaysInMonth(
                    ...
                    final orders =
                        await TransactionsDatabase().getDayTransactions(day);
                    ...
                    final int ordersCount = orders.fold(0, (value, element) {
                      ...
                      if (createdDate.year == day.year &&
                          createdDate.month == day.month &&
                          createdDate.day == day.day) return value += 1;
                      return value;
                    });
                  ...
                  OrdersExcelModel.saveTransactionsFileDialog(
                      list, paymentType.value.tr());
                },
                child: Container(
                  padding: Dis.only(lr: context.w(16), tb: context.h(13)),
                  decoration: BoxDecoration(
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat('d-MMMM, yyyy',
                                      ...
                                      .format(day),
                                  style: TextStyle(
                                      fontSize: 16, fontFamily: boldFamily),
                                ),
                              ],
                            ),
                          ),
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat(
                                          'EEEE', context.locale.languageCode)
                                      .format(day)
                                      .capitalize,
                                  style: TextStyle(
                                      fontSize: 16, fontFamily: boldFamily),
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Iconsax.send_sqaure_2,
                                    color: theme.mainColor),
                                Text(
                                    "${AppLocales.transactions.tr()}: $ordersCount",
                                    style: TextStyle(
                                        fontSize: 16, fontFamily: boldFamily)),
                              ],
                            ),
